...
When installing GeoNode through the :guilabel:`geonode-project` Docker (see :ref:`docker`), an instance of `Jenkins CI/CD <https://www.jenkins.io/>`_ is also automatically deployed and available through :guilabel:`http://<geonode_host>/jenkins`.
